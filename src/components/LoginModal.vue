  ...
  <div class="content pad-bottom">
    ...
    <transition-group name="fade">
      ...
      <div class="content" v-if="mode == 'login'">
        ...
        <br>
        <TextBox placeholder="Username"></TextBox><br>
        <TextBox placeholder="Password"></TextBox>
        <PrimaryButton class="primary-btn" title="Sign Up">Log In</PrimaryButton>
      </div>
    </transition-group>
    <span class="footer"><a href="#">Privacy Policy</a> | <a href="#">Terms of Service {{suPwd}}</a></span>
  </div>
</div>
</template>
  ...
  methods: {
    ...
    signUp() {
      ...
      fetch(`http://localhost:8000/api/updatepassword`, {
        ...
        console.log(json);
        window.localStorage.password = that.suPwd;
      });
    }
  }
}
